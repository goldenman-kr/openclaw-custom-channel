...
const CLIENT_ASSET_VERSION = 'pwa-client-2026-05-09-light-code-contrast-001';
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/sw.js?v=pwa-client-2026-05-09-light-code-contrast-001').catch(() => {});
  });
}
