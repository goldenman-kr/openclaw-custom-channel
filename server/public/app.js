...
import { cancelJobById, fetchJobById, isAlreadyFinishedJobError, isJobResolvedInHistory as isJobResolvedInHistoryFromApi, waitForJobPolling } from './modules/job-api.js?v=pwa-client-2026-05-28-copy-top-align-001';
import { waitForJobEventStream } from './modules/job-events.js?v=pwa-client-2026-05-28-copy-top-align-001';
...
const CLIENT_ASSET_VERSION = 'pwa-client-2026-05-28-copy-top-align-001';
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/sw.js?v=pwa-client-2026-05-28-copy-top-align-001').catch(() => {});
  });
}
